...
export  function Schedule() {
  ...
  // Sample data for energy schedule
  const [energyScheduleData, setEnergyScheduleData] = useState([
    {
      day: "Monday",
      periods: [
        { time: "00:00 - 06:00", type: "Grid", note: "Low demand", efficiency: "Standard" },
        { time: "06:00 - 18:00", type: "Solar", note: "Peak production", efficiency: "High" },
        { time: "18:00 - 00:00", type: "Grid", note: "Evening usage", efficiency: "Standard" },
      ],
    },
    {
      day: "Tuesday",
    ...
    },
    {
      day: "Saturday",
      periods: [
        { time: "00:00 - 08:00", type: "Grid", note: "Low demand", efficiency: "Standard" },
        { time: "08:00 - 16:00", type: "Solar", note: "Weekend usage", efficiency: "Medium" },
        { time: "16:00 - 00:00", type: "Grid", note: "Evening usage", efficiency: "Standard" },
      ],
    },
    {
      day: "Sunday",
  ...
  const [coolingScheduleData, setCoolingScheduleData] = useState([
    { id: 1, room: "Server Room A", days: "Mon-Fri", startTime: "06:00", endTime: "08:00", targetTemp: "22°C", status: "Active" },
    { id: 2, room: "Conference Room", days: "Mon-Fri", startTime: "07:30", endTime: "09:00", targetTemp: "24°C", status: "Active" },
    { id: 3, room: "Office Area", days: "Mon-Fri", startTime: "07:00", endTime: "08:30", targetTemp: "23°C", status: "Active" },
    { id: 4, room: "Reception", days: "Mon-Fri", startTime: "08:00", endTime: "09:30", targetTemp: "24°C", status: "Inactive" },
    { id: 5, room: "Server Room B", days: "Daily", startTime: "05:30", endTime: "07:00", targetTemp: "21°C", status: "Active" },
  ])
  ...
  const handleUpdateCoolingSchedule = () => {
    if (currentEditItem && newCoolingSchedule.room) {
      setCoolingScheduleData(coolingScheduleData.map(item => 
      ...
      <div className="day-timeline">
        ...
        <div className="timeline-periods">
          {periods.map((period, index) => {
            ...
            const endHour = parseInt(endStr.split(":")[0]) || 24;
          ...
          {day === getCurrentDayName() && (
            ...
            >
              ...
              <span className="time-now">{currentTime.toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}</span>
            </div>
          )}
        </div>
      </div>
  ...
  const renderTimelineView = () => {
    ...
    const today = energyScheduleData[dayIndex];
            ...
            <div className="card">
              <div className="card-header">
                <h3 className="card-title">
                  ...
                  7-Day Energy Schedule
                </h3>
                <div className="efficiency-indicator">
                  <Sun className="efficiency-icon" />
                  <span>Solar Usage: {energyStats.solarUsage}</span>
                </div>
              </div>
              <div className="card-content">
                        ...
                        <tr key={day.day} className={isCurrentDay ? "current-day-row" : ""}>
                          <td className="day-name">
                            <div className="day-header">
                              <span className={isCurrentDay ? "current-day" : ""}>
                                {day.day}
                              </span>
                              <button 
                              ...
                              <div className="expanded-view">
                                ...
                                <div className="time-periods">
                                  {day.periods.map((period, index) => (
                                    <div key={index} className={`time-period ${isActivePeriod(period) && isCurrentDay ? 'active-period' : ''}`}>
                                      <span className={`period-type ${period.type.toLowerCase()}`}>
                                        {period.type === "Solar" ? <Sun size={14} /> : <Zap size={14} />}
                                        {period.type}
                                      </span>
                ...
                <div className="stats-panel">
                  <div className="stat-item">
                    <div className="stat-label">Solar Usage</div>
                    <div className="stat-value">{energyStats.solarUsage}</div>
                  </div>
                  <div className="stat-item">
                    <div className="stat-label">Grid Usage</div>
                    <div className="stat-value">{energyStats.gridUsage}</div>
                  </div>
                  <div className="stat-item">
                    <div className="stat-label">Peak Production</div>
                    <div className="stat-value">{energyStats.peakHours}</div>
                  </div>
                  <div className="stat-item">
                    <div className="stat-label">Est. Savings</div>
                    <div className="stat-value savings">{energyStats.estimatedSavings}</div>
                  </div>
                </div>
              </div>
            </div>
